#  tests for h5py-3.10.0-nompi_py311h393cb7e_100 (this is a generated file);
print('===== testing package: h5py-3.10.0-nompi_py311h393cb7e_100 =====');
...
print('===== h5py-3.10.0-nompi_py311h393cb7e_100 OK =====');
print("import: 'h5py'")
import h5py
